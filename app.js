...
async function extractDraftRows(file) {
  ...
  for (let pageNo = 1; pageNo <= pdf.numPages; pageNo++) {
    ...
    for (const group of groups) {
      ...
      // Find the actual player-name line nearest to this draft row.
      // Explicitly exclude club + position strings such as "MUN MID" or
      // "MCI FWD"; this was the source of the previous extraction bug.
      const nearby = playerCandidates
        .map(candidate => ({
          ...candidate,
      ...
      // Prefer the closest valid name, but penalize very short generic UI text.
